...
const WORDS = ["Code,Connect,Create!", "Tech Enthusiast","Curiosity is my curriculum"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/abhishekhubs" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/abhishekshrivastav/" },
  { icon: Instagram, link: "https://www.instagram.com/_wandererkid?igsh=cnB4Njh2YmxiZ3d4" }
];
