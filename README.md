...
- `supabase/setup.sql` — a complete SQL script you can run in Supabase SQL Editor to create tables, policies, storage bucket, and example rows.
- `.env.example` — example environment variables; copy to `.env` and fill with your Supabase project values.
